            ...
            <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <div class="lg:flex lg:items-start lg:gap-8">
                    <div class="mt-8 grid grid-cols-3 gap-32 lg:mt-0 lg:grid-cols-5 lg:gap-y-24">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <p class="font-medium text-gray-900">Healthcare Services</p>

                            <ul className="mt-6 space-y-4 text-sm">
                                <li>
                                    <a href="#" class="text-gray-700 transition hover:opacity-75"> General Checkups </a>
                                </li>

                                <li>
                                    <a href="#" class="text-gray-700 transition hover:opacity-75"> Specialist Consultations </a>
                                </li>

                                <li>
                                    <a href="#" class="text-gray-700 transition hover:opacity-75"> Lab Tests & Diagnostics </a>
                                </li>

                                <li>
                                    <a href="#" class="text-gray-700 transition hover:opacity-75"> Telemedicine </a>
                                </li>

                                <li>
                                    <a href="#" class="text-gray-700 transition hover:opacity-75"> Prescription Refills </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <p class="font-medium text-gray-900">Patient Resources</p>
                            ...
                            <ul class="mt-6 space-y-4 text-sm">
                                ...
                                <li>
                                    <a href="#" class="text-gray-700 transition hover:opacity-75"> Health Tips Blog </a>
                                </li>

                                <li>
                                    <a href="#" class="text-gray-700 transition hover:opacity-75"> Contact Support </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <ul class="mt-6 space-y-4 text-sm">
                                ...
                                <li>
                                    <a href="#" class="text-gray-700 transition hover:opacity-75"> Data Protection </a>
                                </li>
                ...
                <div class="mt-8 border-t border-gray-200 pt-8">
                    <div class="sm:flex sm:justify-between">
                        <p class="text-xs text-gray-500">&copy; 2024. CARENET. All rights reserved.</p>
