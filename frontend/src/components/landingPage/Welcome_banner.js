        ...
        <div className="bg-cover bg-center" style={{ backgroundImage: `url(${homeBg})` }}>
            ...
            <div className="relative flex flex-col items-center justify-center py-32 gap-3">
                <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-black ring-1 ring-gray-400 hover:ring-lime-600">
                        Join CareNet for comprehensive health management{' '}
                        <Link to="/services" className="font-semibold text-lime-500">
                ...
                <div className="flex items-center justify-center gap-x-6">
                    <button className="ring-1 ring-lime-500 text-black px-8 py-1 rounded-full font-semibold text-lg transition duration-300 hover:bg-lime-500">
                        View Dashboard
                    </button>
